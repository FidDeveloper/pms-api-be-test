  ...
  return (
    ...
    >
      <View style={[$styles.row, $wrapper, $styleOverride]}>
        ...
        {rightIcons?.length && props.preset === "profile" && (
          <HeaderMultiIconAction icons={rightIcons} />
        )}
...
function HeaderProfileAction(props: HeaderActionProps) {
  const { backgroundColor, icon, text, tx, txOptions, onPress, ActionComponent, iconColor } = props
  const { themed } = useAppTheme()
    ...
    return (
      ...
      >
        <View style={$actionRowContainer}>
          ...
          <View>
            <Text weight="medium" size="md" text="Hello" style={themed($actionText)} />
            <Text weight="medium" size="md" text={content} style={themed($actionText)} />
          </View>
        </View>
      </TouchableOpacity>
...
function HeaderMultiIconAction(props: HeaderActionProps) {
  const {
    backgroundColor,
    icons,
    text: _text,
    tx: _tx,
    txOptions: _txOptions,
    onPress,
    ActionComponent,
    iconColor,
  } = props
...
const $actionRowContainer: ViewStyle = {
  flexDirection: "row",
  justifyContent: "center",
  alignItems: "center",
  gap: 1,
...
const $petInfoContainer: ViewStyle = {
  marginEnd: 20,
}
