import { type ComponentRef, ReactNode, useRef, useState } from "react"
import {
...
function ScreenWithScrolling(props: ScreenProps) {
  ...
  const ref = useRef<ComponentRef<typeof KeyboardAwareScrollView>>(null)
...
export function Screen(props: ScreenProps) {
  ...
  const isScrollingPreset = !isNonScrolling(props.preset)
  ...
  return (
    ...
    >
      ...
      <KeyboardAvoidingView
        behavior={isScrollingPreset ? undefined : isIos ? "padding" : "height"}
        enabled={!isScrollingPreset}
