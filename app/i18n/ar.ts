...
const ar: Translations = {
  ...
  loginAccount: {
    heading: "تسجيل الدخول إلى حسابي",
    subheading: "مرحباً! يرجى إدخال معلوماتك أدناه للبدء.",
  ...
  boardingScreen: {
    ...
    description: "ابدأ رحلتك معنا واستمتع بتجربة فريدة.",
    getStartedButton: "ابدأ الآن",
    skipSignUp: "تخطي التسجيل",
    title1: "ملفات تعريف الحيوانات الأليفة الشخصية",
    description1: "قم بإنشاء ملفات تعريف مخصصة لحيواناتك الأليفة وتابع نشاطها بسهولة.",
    title2: "تذكيرات رعاية الحيوانات الأليفة",
    description2:
      "لا تنسى مواعيد الطبيب البيطري أو جدول الأدوية مرة أخرى! قم بإعداد تذكيرات مخصصة لكل من حيواناتك الأليفة وتلقي إشعارات في الوقت المناسب للحفاظ على صحتهم وسعادتهم.",
    title3: "الاتصال بالمجتمع",
    description3:
      "انضم إلى مجتمع نابض بالحياة من محبي الحيوانات الأليفة! شارك الصور والقصص والنصائح حول أصدقائك الفرويين، وتواصل مع الآخرين الذين يشاركونك شغفك بالحيوانات الأليفة.",
  },
  SignupScreen: {
    button: "تسجيل",
    Checkbox: "أوافق على الشروط والأحكام",
    title: "إنشاء حساب",
    subtitle: "مرحباً! يرجى إدخال معلوماتك أدناه والبدء.",
  },
  ValidationScreen: {
    button: "تأكيد",
    title: "رمز التحقق",
    subtitle: "تحقق من بريدك الإلكتروني وأدخل رمز التحقق هنا",
    link1: "لم تستلم الرمز؟",
    link2: "إعادة الإرسال",
  },
  DashboardScreen: {
    button: "اسحب للمتابعة",
    content: "يبدو أنه لا يوجد ملف تعريف لديك حالياً، أضف حيوانك الأليف الآن",
    subtitle: "تحقق من بريدك الإلكتروني وأدخل رمز التحقق هنا",
    link1: "لم تستلم الرمز؟",
    link2: "إعادة الإرسال",
  },
  AddPetNameScreen: {
    button: "اسحب للمتابعة",
    title: "ما اسم حيوانك الأليف؟",
    input: "اسم حيوانك الأليف",
    link1: "لم تستلم الرمز؟",
    link2: "إعادة الإرسال",
  },
  AddPetSizeRangeScreen: {
    button: "متابعة",
    title: "ما حجم حيوانك الأليف؟",
    input: "اسم حيوانك الأليف",
    link1: "لم تستلم الرمز؟",
    link2: "إعادة الإرسال",
  },
