...
const hi: Translations = {
  ...
  loginAccount: {
    heading: "मेरे खाते में लॉगिन करें",
    subheading: "स्वागत है। शुरू करने के लिए नीचे अपनी जानकारी दर्ज करें।",
  ...
  boardingScreen: {
    title: "व्यक्तिगत पालतू प्रोफाइल",
    description:
      "Furtory Pet Centre पर अपने प्रत्येक प्रिय पालतू जानवर के लिए व्यक्तिगत प्रोफाइल बनाएं। उनका नाम, नस्ल और उम्र साझा करें और एक जीवंत समुदाय से जुड़ें।",
    getStartedButton: "शुरुआत करें",
    skipSignUp: "बाद में साइन अप करें",
    title1: "व्यक्तिगत पालतू प्रोफाइल",
    description1:
      "Furtory Pet Centre पर अपने प्रत्येक प्रिय पालतू जानवर के लिए व्यक्तिगत प्रोफाइल बनाएं। उनका नाम, नस्ल और उम्र साझा करें और एक जीवंत समुदाय से जुड़ें।",
    title2: "पालतू देखभाल अनुस्मारक",
    description2:
      "कभी भी एक पशु चिकित्सक की नियुक्ति या दवा अनुसूची को फिर से न भूलें! अपने प्रत्येक पालतू के लिए कस्टम अनुस्मारक सेट करें और उन्हें स्वस्थ और खुश रखने के लिए समय पर सूचनाएं प्राप्त करें।",
    title3: "समुदाय कनेक्शन",
    description3:
      "पालतू प्रेमियों के एक जीवंत समुदाय में शामिल हों! अपने प्यारे दोस्तों की तस्वीरें, कहानियां और सलाह साझा करें, और अन्य लोगों के साथ जुड़ें जो पालतू जानवरों के लिए आपके जुनून को साझा करते हैं।",
  },
  SignupScreen: {
    button: "रजिस्टर करें",
    Checkbox: "नियम और शर्तें स्वीकार करें",
    title: "खाता बनाएं",
    subtitle: "स्वागत है। शुरू करने के लिए नीचे अपनी जानकारी दर्ज करें।",
  },
  ValidationScreen: {
    button: "पुष्टि करें",
    title: "सत्यापन कोड",
    subtitle: "अपना ईमेल जांचें और यहां सत्यापन कोड दर्ज करें",
    link1: "कोड प्राप्त नहीं हुआ?",
    link2: "फिर से भेजें",
  },
  DashboardScreen: {
    button: "जारी रखने के लिए स्वाइप करें",
    content: "लगता है आपका प्रोफाइल अभी सेट नहीं है, अभी अपना पालतू जोड़ें",
    subtitle: "अपना ईमेल जांचें और यहां सत्यापन कोड दर्ज करें",
    link1: "कोड प्राप्त नहीं हुआ?",
    link2: "फिर से भेजें",
  },
  AddPetNameScreen: {
    button: "जारी रखने के लिए स्वाइप करें",
    title: "आपके पालतू का नाम क्या है",
    input: "आपके पालतू का नाम",
    link1: "कोड प्राप्त नहीं हुआ?",
    link2: "फिर से भेजें",
  },
  AddPetSizeRangeScreen: {
    button: "जारी रखें",
    title: "आपके पालतू का आकार क्या है",
    input: "आपके पालतू का नाम",
    link1: "कोड प्राप्त नहीं हुआ?",
    link2: "फिर से भेजें",
  },
