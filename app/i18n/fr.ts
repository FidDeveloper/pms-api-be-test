...
const fr: Translations = {
  ...
  loginAccount: {
    ...
    subheading: "Bienvenue. Veuillez saisir vos informations ci-dessous pour commencer.",
  ...
  boardingScreen: {
    title: "Profils personnalisés pour vos animaux de compagnie",
    description:
      "Créez des profils personnalisés pour chacun de vos animaux de compagnie bien-aimés sur Furtory Pet Centre. Partagez leur nom, leur âge et leurs préférences pour une expérience plus personnalisée.",
    getStartedButton: "Commencez maintenant",
    skipSignUp: "Passer l'inscription",
    title1: "Profils personnalisés pour animaux de compagnie",
    description1:
      "Créez des profils personnalisés pour chacun de vos animaux de compagnie bien-aimés sur Furtory Pet Centre. Partagez leur nom, leur âge et leurs préférences pour une expérience plus personnalisée.",
    title2: "Rappels de soins pour animaux de compagnie",
    description2:
      "Ne manquez jamais un rendez-vous chez le vétérinaire ou un horaire de médication ! Configurez des rappels personnalisés pour chacun de vos animaux de compagnie et recevez des notifications en temps opportun pour les garder en bonne santé et heureux.",
    title3: "Connexion communautaire",
    description3:
      "Rejoignez une communauté vibrante d'amoureux des animaux ! Partagez des photos, des histoires et des conseils sur vos amis à fourrure, et connectez-vous avec d'autres qui partagent votre passion pour les animaux de compagnie.",
  },
  SignupScreen: {
    button: "S'inscrire",
    Checkbox: "Accepter les conditions générales",
    title: "Créer un compte",
    subtitle: "Bienvenue. Veuillez saisir vos informations ci-dessous pour commencer.",
  },
  ValidationScreen: {
    button: "Confirmer",
    title: "Code de validation",
    subtitle: "Vérifiez votre e-mail et saisissez le code de validation ici",
    link1: "Vous n'avez pas reçu le code ?",
    link2: "Renvoyer",
  },
  DashboardScreen: {
    button: "Glissez pour continuer",
    content: "Il semble que vous n'ayez pas encore de profil, ajoutez votre animal maintenant",
    subtitle: "Vérifiez votre e-mail et saisissez le code de validation ici",
    link1: "Vous n'avez pas reçu le code ?",
    link2: "Renvoyer",
  },
  AddPetNameScreen: {
    button: "Glissez pour continuer",
    title: "Comment s'appelle votre animal ?",
    input: "Nom de votre animal",
    link1: "Vous n'avez pas reçu le code ?",
    link2: "Renvoyer",
  },
  AddPetSizeRangeScreen: {
    button: "Continuer",
    title: "Quelle est la taille de votre animal ?",
    input: "Nom de votre animal",
    link1: "Vous n'avez pas reçu le code ?",
    link2: "Renvoyer",
  },
