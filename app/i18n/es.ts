...
const es: Translations = {
  ...
  loginAccount: {
    heading: "Inicia sesión en mi cuenta",
    subheading: "Bienvenido. Ingresa tu información abajo para comenzar.",
  ...
  boardingScreen: {
    title: "Perfiles personalizados para tus mascotas",
    description:
      "Crea perfiles personalizados para cada una de tus queridas mascotas en Furtory Pet Centre. Comparte su nombre, raza y edad mientras te conectas con una vibrante comunidad.",
    getStartedButton: "Comenzar",
    skipSignUp: "Registrarme más tarde",
    title1: "Perfiles personalizados para mascotas",
    description1:
      "Crea perfiles personalizados para cada una de tus queridas mascotas en Furtory Pet Centre. Comparte su nombre, raza y edad mientras te conectas con una vibrante comunidad.",
    title2: "Recordatorios para el cuidado de mascotas",
    description2:
      "¡Nunca olvides una cita con el veterinario o un horario de medicación nuevamente! Configura recordatorios personalizados para cada una de tus mascotas y recibe notificaciones oportunas para mantenerlas saludables y felices.",
    title3: "Conexión comunitaria",
    description3:
      "¡Únete a una vibrante comunidad de amantes de las mascotas! Comparte fotos, historias y consejos sobre tus amigos peludos, y conéctate con otros que comparten tu pasión por las mascotas.",
  },
  SignupScreen: {
    button: "Registrarse",
    Checkbox: "Aceptar términos y condiciones",
    title: "Crear cuenta",
    subtitle: "Bienvenido. Ingresa tu información abajo para comenzar.",
  },
  ValidationScreen: {
    button: "Confirmar",
    title: "Código de validación",
    subtitle: "Revisa tu correo e ingresa aquí el código de validación",
    link1: "¿No recibiste el código?",
    link2: "Reenviar",
  },
  DashboardScreen: {
    button: "Desliza para continuar",
    content: "Parece que no tienes un perfil configurado, agrega tu mascota ahora",
    subtitle: "Revisa tu correo e ingresa aquí el código de validación",
    link1: "¿No recibiste el código?",
    link2: "Reenviar",
  },
  ...
  AddPetSizeRangeScreen: {
    button: "Continuar",
    title: "¿Cual es el tamano de tu mascota?",
    input: "Nombre de tu mascota",
    link1: "¿No recibiste el código?",
    link2: "Reenviar",
  },
